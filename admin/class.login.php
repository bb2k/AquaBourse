...
class logmein {
    ...
    var $hostname_logon = ''; //$config["sql_server"];      //Database server LOCATION
    ...
    var $user_column = 'Mail';     //USERNAME column (value MUST be valid email)
    ...
    function dbconnect(){
 	...
 	$this->hostname_logon  =  $config["sql_server"];
	$this->username_logon  =  $config["sql_login"];
	$this->password_logon  =  $config["sql_password"];
	$this->database_logon  =  $config["sql_db"] ;
    ...
    function login($table, $username, $password){
        ...
        if($row != "Error"){
            if($row[$this->user_column] !="" && $row[$this->pass_column] !=""){
                ...
                $_SESSION['loggedinadmin'] = $row[$this->pass_column];
    ...
    function passwordreset($username, $user_table, $pass_column, $user_column){
        ...
        if(sizeof($getemail) > 2){
            ...
            $subject = "Nouveau mot de passe : ".$_SERVER['SERVER_NAME'];
            $msg = "
 
Votre nouveau mot de passe est le suivant : ".$newpassword."
...
<div><label for="username">Mail</label></div>
<input name="username" id="username" type="text">
<div class="password"><label for="password">Password</label></div>
<input name="password" id="password" type="password">
<input name="action" id="action" value="login" type="hidden">
<input name="submit" id="submit" value="Valider" type="submit" class="connexion">
</form>
...
<div>
<br/>
<input name="submit" id="submit" value="Réinitialiser" type="submit" class="connexion"></div>
</form>
